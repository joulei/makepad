...
public class MakepadNative {
    ...
    // video decoding
    public static native void onVideoDecodingInitialized(long videoId, int frameRate, int videoWidth, int videoHeight, String colorFormat, long duration, SurfaceTexture surfaceTexture);
