    ...
    pub fn run(&self, what: BuildProcess, cmd_id: LiveId, http: String) {
        ...
        let args: Vec<String> = match &what.target {
            ...
            BuildTarget::IosDevice => vec![
                ...
                format!("--org={}", "my.test"),
                format!("--app={}", "moly"),
                format!("--profile=95a5dbdd-6a4a-496c-a404-60d113774ec0"),
                format!("--cert=48F05B9CF7DB971DD878B7EE2E070757445FDDB5"),
                format!("--device=CC4025DA-FDFC-5EB2-9918-F2575AA082FA"),
                "run-device".into(),
                "-p".into(),
                what.binary.clone(),
                "--release".into(),
